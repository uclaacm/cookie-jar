...
const CookieJarGame: React.FC = () => {
    ...
    const cookieImages = [c1, c2, c3, c4, c5, c7, c8, c6, c1, c2, c6, c9, c4, c5, c3];
    const cookieLandingPositions = [630, 630, 600, 550, 530, 540, 475, 480, 430, 400, 390, 410, 350, 310, 315];
...
const Home: React.FC = () => {
    return (
      <div className="home-container">
        ...
        <h1>Cookie Jar</h1>
        <p>
            What are web cookies? What type of cookies are out there? In Cookie Jar, 
            we’ll learn all about web cookies and they make life easier. Have fun!
        </p>
        <Button className="start-button">Menu </Button>
        </div>
